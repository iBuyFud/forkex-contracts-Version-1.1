...
contract sForkex is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Forkex", "sFORK", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFORK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFORK
